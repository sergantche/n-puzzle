...
| `NPuzzle/Rect/Thin.lean` | `rows_eq_one_of_lt_two`, `cols_eq_one_of_lt_two`, `tileList_slide_horizontal`, `tileList_slide_vertical_of_cols_eq_one`, `tileList_reachable_of_rows_eq_one`, `tileList_reachable_of_cols_eq_one`, `tileList_reachable_of_rows_lt_two`, `tileList_reachable_of_cols_lt_two`, thin-board goal obstruction lemmas, `reachable_goal_of_tileList_rows_eq_one`, `reachable_goal_of_tileList_cols_eq_one`, `reachable_goal_of_tileList_rows_lt_two`, `reachable_goal_of_tileList_cols_lt_two`, `solvability_rows_eq_one`, `solvability_cols_eq_one`, `solvability_rows_lt_two`, `solvability_cols_lt_two` |
