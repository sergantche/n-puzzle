...
| `NPuzzle/Rect/PathEffect.lean` | `listEndpoint`, `swapAlongList`, `cellPermAlongList`, `swapAlongList_append`, `cellPermAlongList_append`, `cellPermAlongList_eq_formPerm_cons`, `swapAlongList_eq_cellPermAlongList`, `swapAlongList_of_not_mem`, `swapAlongBlankPathStart`, `swapAlongBlankPathStart_eq_swapAlongList`, `followBlankGridPathStart_cells` |
