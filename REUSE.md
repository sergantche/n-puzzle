...
| `NPuzzle/Rect/EvenColumnRoute.lean` | `evenColsBottomTail`, `evenColsUpperColumn`, `evenColsUpperSnake`, `evenColsRouteXs`, `evenColsUpperColumn_length`, `evenColsUpperSnake_length`, `evenColsRoute_length`, `isChain_evenColsBottomTail`, `isChain_evenColsUpperColumn`, `isChain_evenColsUpperSnake`, `evenColsRoute_chain_open`, `evenColsBottomTail_nonblank`, `evenColsUpperSnake_nonblank`, `evenColsRoute_nonblank`, `evenColsBottomTail_nodup_cells`, `evenColsUpperColumn_nodup`, `evenColsUpperSnake_nodup`, `evenColsRoute_nodup_cells`, `evenColsRoute_nodup`, `evenColsRoute_covers` |
