...
| `NPuzzle/Rect/PathList.lean` | `AdjacentChain`, `blankGridPathOfList`, `closedBlankGridPathOfList`, `vertices_blankGridPathOfList`, `vertices_closedBlankGridPathOfList` |
...
| `NPuzzle/Rect/PathSufficiency.lean` | `reachable_goal_to_cfg_bottomRight_of_closedFullPath`, `tiles_to_goal_bottomRight_of_closedFullPath`, `reachable_goal_to_cfg_bottomRight_of_leftClosedFullPath`, `tiles_to_goal_bottomRight_of_leftClosedFullPath`, `reachable_goal_to_cfg_bottomRight_of_leftClosedFullList`, `tiles_to_goal_bottomRight_of_leftClosedFullList` |
