...
| `NPuzzle/Rect/PathEffect.lean` | `listEndpoint`, `swapAlongList`, `swapAlongList_append`, `swapAlongList_of_not_mem`, `swapAlongBlankPathStart`, `swapAlongBlankPathStart_eq_swapAlongList`, `followBlankGridPathStart_cells` |
