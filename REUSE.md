...
| `NPuzzle/Rect/TwoColumnRoute.lean` | `colZero`, `colOneOfTwo`, `rowFromRowsMinusTwo`, `rowFromRowsMinusOne`, `finList_toFinset_eq_univ_of_nodup_length`, `isChain_finRange_val_succ`, `isChain_finRange_reverse_val_pred`, `isChain_twoColumn_leftTail`, `isChain_twoColumn_rightColumn`, `twoColumnRouteYs`, `twoColumnRoute_nonblank`, `twoColumnRoute_length`, `twoColumnRoute_nodup_cells`, `twoColumnRoute_nodup`, `twoColumnRoute_covers`, two-column corner coordinate lemmas |
