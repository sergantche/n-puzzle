...
| `NPuzzle/Rect/EvenDimension.lean` | `Board.evenDimension_or_oddRows_oddCols`, `Board.oddRows_oddCols_of_not_evenDimension`, `Board.not_evenDimension_iff_oddRows_oddCols`, `Board.size_mod_two_eq_zero_of_evenDimension`, `Board.evenDimension_iff_size_mod_two_eq_zero`, `Board.oddRows_oddCols_iff_size_mod_two_eq_one`, `Board.not_evenDimension_iff_size_mod_two_eq_one`, `reachable_goal_to_cfg_bottomRight_of_evenDimension`, `tiles_to_goal_bottomRight_of_evenDimension`, `reachable_goal_to_cfg_bottomRight_of_dimension_split`, `tiles_to_goal_bottomRight_of_dimension_split` |
